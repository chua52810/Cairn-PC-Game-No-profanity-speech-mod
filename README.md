# Cairn-PC-Game-No-profanity-speech-mod
...
2. Go to the game directory at "Your Drive\Cairn\Cairn_Data\StreamingAssets\Audio\GeneratedSoundBanks\Windows\English(US)".
3. Rename the original character.bnk and dialogue.bnk as character1.bnk and dialogue1.bnk. 
4. Copy character.bnk and dialogue.bnk from Gitgub to replace the originals.
